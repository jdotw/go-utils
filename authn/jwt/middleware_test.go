...
var (
	...
	authn             = Authenticator{tracer: opentracing.NoopTracer{}, logger: log.NewMockLogFactory()}
)
...
func TestJWTParser(t *testing.T) {
	...
	parser := newParser(keys, method, MapClaimsFactory, authn)(e)
	...
	badParser := newParser(keys, invalidMethod, MapClaimsFactory, authn)(e)
	...
	badParser = newParser(invalidKeys, method, MapClaimsFactory, authn)(e)
	ctx = context.WithValue(context.Background(), JWTContextKey, signedKey)
	_, err = badParser(ctx, struct{}{})
	if err == nil {
		t.Error("Parser should have returned an error")
	...
	parser = newParser(keys, method, StandardClaimsFactory, authn)(e)
	...
	parser = newParser(keys, method, func() jwt.Claims { return &customClaims{} }, authn)(e)
...
func TestIssue562(t *testing.T) {
	var (
		...
		e   = newParser(kf, jwt.SigningMethodHS256, MapClaimsFactory, authn)(endpoint.Nop)
		key = JWTContextKey
